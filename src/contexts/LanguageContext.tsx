...
const translations = {
  en: {
    ...
    'cv.subtitle': 'Download my complete professional resume',
    'cv.download.title': 'Download Resume',
    'cv.download.description': 'Get the full details of my professional experience, education, and skills in PDF format.',
    'cv.download.button': 'Download CV',
    'cv.format': 'Format',
    'cv.updated': 'Last Updated',
    'cv.languages': 'Languages',
    'cv.note': 'File includes detailed information about my professional background, technical skills, and project experience.',
  },
  es: {
    'nav.home': 'Inicio',
    'nav.about': 'Sobre Mí',
    ...
    'cv.title': 'Curriculum Vitae',
    'cv.subtitle': 'Descarga mi currículum profesional completo',
    'cv.download.title': 'Descargar Currículum',
    'cv.download.description': 'Obtén los detalles completos de mi experiencia profesional, educación y habilidades en formato PDF.',
    'cv.download.button': 'Descargar CV',
    'cv.format': 'Formato',
    'cv.updated': 'Última Actualización',
    'cv.languages': 'Idiomas',
    'cv.note': 'El archivo incluye información detallada sobre mi trayectoria profesional, habilidades técnicas y experiencia en proyectos.',
  },
};
